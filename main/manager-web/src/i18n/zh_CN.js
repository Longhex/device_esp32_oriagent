export default {
  ...
  'header.deviceMonitor': '设备监控',
  'header.serialManagement': '序列号管理',
  'deviceMonitor.title': '设备监控',
  'deviceMonitor.refresh': '刷新',
  'deviceMonitor.autoRefresh': '自动',
  'deviceMonitor.serial': '序列号',
  'deviceMonitor.status': '状态',
  'deviceMonitor.online': '在线',
  'deviceMonitor.offline': '离线',
  'deviceMonitor.battery': '电量',
  'deviceMonitor.uptime': '运行时长',
  'deviceMonitor.lastSeen': '最后更新',
  'deviceMonitor.action': '操作',
  'deviceMonitor.reboot': '重启',
  'deviceMonitor.command': '命令',
  'deviceMonitor.detail': '详情',
  'deviceMonitor.noDevices': '暂无设备',
  'deviceMonitor.sendCommand': '发送命令',
  'deviceMonitor.action2': '动作',
  'deviceMonitor.params': '参数 (JSON)',
  'deviceMonitor.cancel': '取消',
  'deviceMonitor.send': '发送',
  'deviceMonitor.confirmReboot': '重启设备 {serial}？',
  'deviceMonitor.invalidJson': '参数 JSON 无效',
  'deviceMonitor.commandSent': '命令已发送',
  'serialManagement.title': '序列号管理',
  'serialManagement.declare': '申报序列号',
  'serialManagement.refresh': '刷新',
  'serialManagement.serialNumber': '序列号',
  'serialManagement.statusCol': '状态',
  'serialManagement.activated': '已激活',
  'serialManagement.declared': '已申报',
  'serialManagement.batch': '批次',
  'serialManagement.declaredAt': '申报时间',
  'serialManagement.activatedAt': '激活时间',
  'serialManagement.action': '操作',
  'serialManagement.activate': '激活',
  'serialManagement.unbind': '解绑',
  'serialManagement.noSerials': '暂无序列号',
  'serialManagement.cancel': '取消',
  'serialManagement.confirm': '确认',
  'serialManagement.credential': 'MQTT 凭证',
  'serialManagement.credentialHint': '密码仅显示一次，请保存并写入设备。',
  'serialManagement.copy': '复制',
  'serialManagement.close': '关闭',
  'serialManagement.serialRequired': '请输入序列号',
  'serialManagement.declareSuccess': '序列号已申报',
  'serialManagement.copied': '已复制',
  'serialManagement.confirmUnbind': '解绑设备 {serial}？（删除凭证+状态）',
  'serialManagement.unbindSuccess': '设备已解绑',
  'header.emojiManagement': '表情/资源管理',
  'emojiManagement.title': '表情 / 资源管理',
  'emojiManagement.searchPlaceholder': '请输入名称搜索',
  'emojiManagement.name': '资源名称',
  'emojiManagement.version': '版本号',
  'emojiManagement.fileSize': '文件大小',
  'emojiManagement.remark': '备注',
  'emojiManagement.updateTime': '更新时间',
  'emojiManagement.action': '操作',
  'emojiManagement.addNew': '上传表情(.tar)',
  'emojiManagement.edit': '替换文件',
  'emojiManagement.delete': '删除',
  'emojiManagement.copyLink': '复制下载链接',
  'emojiManagement.copied': '已复制下载链接',
  'emojiManagement.copyFailed': '复制失败，请手动复制',
  'emojiManagement.download': '下载',
  'emojiManagement.empty': '暂无表情文件，点击"上传表情"添加。',
  'emojiManagement.dialogTitle': '上传表情文件',
  'emojiManagement.dialogEditTitle': '替换表情文件（下载链接保持不变）',
  'emojiManagement.fileTip': '仅支持 .tar/.gz/.zip 压缩文件，不超过100MB',
  'emojiManagement.requiredName': '请输入资源名称',
  'emojiManagement.requiredFile': '请选择 .tar 文件上传',
  'emojiManagement.invalidFileType': '只允许 .tar/.gz/.zip 文件',
  'emojiManagement.invalidFileSize': '文件大小不能超过100MB',
  'emojiManagement.uploadSuccess': '上传成功',
  'emojiManagement.uploadFailed': '上传失败',
  'emojiManagement.saveSuccess': '保存成功',
  'emojiManagement.saveFailed': '保存失败',
  'emojiManagement.deleteSuccess': '已删除',
  'emojiManagement.confirmDelete': '确定要删除该表情文件吗？',
  'emojiManagement.linkLabel': '固定下载链接',
  'emojiManagement.typeColumn': '类型',
  'emojiManagement.resourceType': '资源类型',
  'emojiManagement.resourceTypePlaceholder': '如: emoj, logo, music, video',
  'emojiManagement.resourceTypeHint': '每种类型对应一个独立的固定下载链接。仅限小写字母、数字和短横线，创建后不可修改。',
  'emojiManagement.requiredType': '请输入资源类型',
  'emojiManagement.invalidType': '仅限小写字母、数字和短横线(-)',
  'emojiManagement.viewApi': '查看资源API',
  'emojiManagement.copyApiUrl': '复制API链接',
  ...
  'ttsModel.voice': '音色',
  'ttsModel.addNewVoice': '新增音色',
  'ttsModel.voiceNameKeyRequired': '每个音色需填写名称和API密钥',
  'ttsModel.voiceNameTooLong': '音色名称最多20个字符',
  'ttsModel.voiceNameDuplicate': '音色名称重复',
  'ttsModel.preview': '试听',
