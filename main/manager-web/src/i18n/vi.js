export default {
  ...
  'header.deviceMonitor': 'Giám sát thiết bị',
  'header.serialManagement': 'Quản lý Serial',
  'deviceMonitor.title': 'Giám sát thiết bị',
  'deviceMonitor.refresh': 'Làm mới',
  'deviceMonitor.autoRefresh': 'Tự động',
  'deviceMonitor.serial': 'Serial',
  'deviceMonitor.status': 'Trạng thái',
  'deviceMonitor.online': 'Trực tuyến',
  'deviceMonitor.offline': 'Ngoại tuyến',
  'deviceMonitor.battery': 'Pin',
  'deviceMonitor.uptime': 'Thời gian chạy',
  'deviceMonitor.lastSeen': 'Cập nhật cuối',
  'deviceMonitor.action': 'Hành động',
  'deviceMonitor.reboot': 'Khởi động lại',
  'deviceMonitor.command': 'Lệnh',
  'deviceMonitor.detail': 'Chi tiết',
  'deviceMonitor.noDevices': 'Chưa có thiết bị nào',
  'deviceMonitor.sendCommand': 'Gửi lệnh',
  'deviceMonitor.action2': 'Hành động',
  'deviceMonitor.params': 'Tham số (JSON)',
  'deviceMonitor.cancel': 'Hủy',
  'deviceMonitor.send': 'Gửi',
  'deviceMonitor.confirmReboot': 'Khởi động lại thiết bị {serial}?',
  'deviceMonitor.invalidJson': 'Tham số JSON không hợp lệ',
  'deviceMonitor.commandSent': 'Đã gửi lệnh',
  'serialManagement.title': 'Quản lý Serial',
  'serialManagement.declare': 'Khai báo serial',
  'serialManagement.refresh': 'Làm mới',
  'serialManagement.serialNumber': 'Số Serial',
  'serialManagement.statusCol': 'Trạng thái',
  'serialManagement.activated': 'Đã kích hoạt',
  'serialManagement.declared': 'Đã khai báo',
  'serialManagement.batch': 'Lô',
  'serialManagement.declaredAt': 'Khai báo lúc',
  'serialManagement.activatedAt': 'Kích hoạt lúc',
  'serialManagement.action': 'Hành động',
  'serialManagement.activate': 'Kích hoạt',
  'serialManagement.unbind': 'Gỡ',
  'serialManagement.noSerials': 'Chưa có serial nào',
  'serialManagement.cancel': 'Hủy',
  'serialManagement.confirm': 'Xác nhận',
  'serialManagement.credential': 'MQTT Credential',
  'serialManagement.credentialHint': 'Mật khẩu chỉ hiện 1 lần. Hãy lưu lại / nạp vào thiết bị.',
  'serialManagement.copy': 'Sao chép',
  'serialManagement.close': 'Đóng',
  'serialManagement.serialRequired': 'Vui lòng nhập số Serial',
  'serialManagement.declareSuccess': 'Đã khai báo serial',
  'serialManagement.copied': 'Đã sao chép',
  'serialManagement.confirmUnbind': 'Gỡ thiết bị {serial}? (xóa credential + trạng thái)',
  'serialManagement.unbindSuccess': 'Đã gỡ thiết bị',
  'header.emojiManagement': 'Quản lý Emoji/Tài nguyên',
  'emojiManagement.title': 'Quản lý Emoji / Tài nguyên',
  'emojiManagement.searchPlaceholder': 'Nhập tên để tìm kiếm',
  'emojiManagement.name': 'Tên tài nguyên',
  'emojiManagement.version': 'Phiên bản',
  'emojiManagement.fileSize': 'Kích thước',
  'emojiManagement.remark': 'Ghi chú',
  'emojiManagement.updateTime': 'Cập nhật lúc',
  'emojiManagement.action': 'Thao tác',
  'emojiManagement.addNew': 'Thêm tài nguyên (.tar)',
  'emojiManagement.edit': 'Thay tệp',
  'emojiManagement.delete': 'Xóa',
  'emojiManagement.copyLink': 'Sao chép link tải',
  'emojiManagement.copied': 'Đã sao chép link tải xuống',
  'emojiManagement.copyFailed': 'Sao chép thất bại, vui lòng copy thủ công',
  'emojiManagement.download': 'Tải xuống',
  'emojiManagement.empty': 'Chưa có tài nguyên nào. Bấm "Thêm tài nguyên" để tải lên.',
  'emojiManagement.dialogTitle': 'Tải lên tài nguyên',
  'emojiManagement.dialogEditTitle': 'Thay tệp Emoji (giữ nguyên link tải)',
  'emojiManagement.fileTip': 'Chỉ hỗ trợ tệp nén .tar/.gz/.zip, tối đa 100MB',
  'emojiManagement.requiredName': 'Vui lòng nhập tên tài nguyên',
  'emojiManagement.requiredFile': 'Vui lòng chọn tệp .tar để tải lên',
  'emojiManagement.invalidFileType': 'Chỉ cho phép tệp .tar/.gz/.zip',
  'emojiManagement.invalidFileSize': 'Kích thước tệp không được vượt quá 100MB',
  'emojiManagement.uploadSuccess': 'Tải lên thành công',
  'emojiManagement.uploadFailed': 'Tải lên thất bại',
  'emojiManagement.saveSuccess': 'Lưu thành công',
  'emojiManagement.saveFailed': 'Lưu thất bại',
  'emojiManagement.deleteSuccess': 'Đã xóa',
  'emojiManagement.confirmDelete': 'Bạn có chắc muốn xóa tệp emoji này?',
  'emojiManagement.linkLabel': 'Link tải cố định',
  'emojiManagement.typeColumn': 'Loại',
  'emojiManagement.resourceType': 'Loại tài nguyên',
  'emojiManagement.resourceTypePlaceholder': 'vd: emoj, logo, music, video',
  'emojiManagement.resourceTypeHint': 'Mỗi loại là 1 link tải cố định riêng. Chỉ dùng chữ thường, số và dấu gạch ngang. Không sửa được sau khi tạo.',
  'emojiManagement.requiredType': 'Vui lòng nhập loại tài nguyên',
  'emojiManagement.invalidType': 'Chỉ gồm chữ thường, số và dấu gạch ngang (-)',
  'emojiManagement.viewApi': 'Xem API tài nguyên',
  'emojiManagement.copyApiUrl': 'Sao chép link API',
  ...
  'account.workspaceName': 'Oriagent Workspace',
  'account.settings': 'Cài đặt',
  'account.feedback': 'Phản hồi',
  'account.community': 'Cộng đồng',
  'account.helpCenter': 'Trung tâm trợ giúp',
  'account.about': 'Về chúng tôi',
  'settings.title': 'Cài đặt',
  'settings.workspaceGroup': 'Workspace',
  'settings.accountGroup': 'Account',
  'settings.dataSource': 'Nguồn dữ liệu',
  'settings.apiExtension': 'Mở rộng dựa trên API',
  ...
  'settings.comingSoon': 'Tính năng đang phát triển',
  'settings.ds.add': 'Thêm nguồn dữ liệu',
  'settings.ds.notionDesc': 'Sử dụng Notion như một nguồn dữ liệu cho Kiến thức.',
  'settings.ds.addWorkspace': 'Thêm không gian làm việc',
  'settings.ds.websiteDesc': 'Nhập nội dung từ website bằng trình thu thập web.',
  'settings.ds.configure': 'Cấu hình',
  'settings.int.connected': 'Đã kết nối',
  'settings.int.googleDesc': 'Đăng nhập bằng tài khoản Google',
  'settings.int.githubDesc': 'Đăng nhập bằng tài khoản GitHub',
  'settings.int.connect': 'Kết nối',
  'settings.api.desc': 'Các tiện ích API cung cấp quản lý API tập trung, giúp cấu hình dễ sử dụng trên các ứng dụng.',
  'settings.api.empty': 'Chưa có phần mở rộng API',
  'settings.api.add': 'Thêm Phần mở rộng API',
  ...
  // auth.*: dùng chung cho login + register (hai trang cùng một thiết kế, cùng chữ).
  // Các key login.*/register.* cũ là của thiết kế trước, giữ nguyên cho phần chưa thay.
  'auth.title': 'Quản lý thiết bị',
  'auth.subtitle': 'Kết nối thiết bị ESP32 vào hệ thống AI Agent',
  'auth.google': 'Đăng nhập hoặc đăng ký bằng Google',
  'auth.or': 'hoặc',
  'auth.emailLabel': 'Địa chỉ Email',
  'auth.emailPlaceholder': 'Email của bạn',
  ...
  'auth.captchaLabel': 'Mã xác nhận',
  'auth.captchaPlaceholder': 'Nhập mã xác nhận',
  ...
  'ttsModel.voiceNamePlaceholder': 'VD: Giọng Mai',
  'functionDialog.jsonPlaceholder': 'Nhập JSON hợp lệ',
  'cacheViewer.status': 'Trạng thái',
  'cacheViewer.cached': 'Đã cache',
  'cacheViewer.notCached': 'Chưa cache',
  'studio.navSettings': 'Thiết lập',
  'home.searchPlaceholder': 'Tìm kiếm Robot Agent',
  'roleConfig.oriagentKeyPlaceholder': 'Nhập key riêng (app-...); để trống = dùng key chung của model',
  'roleConfig.fillerPreviewTitle': 'Nghe thử câu đệm bằng giọng agent',
  'roleConfig.fillerDelayLabel': 'Thời gian chờ (ms)',
  'roleConfig.fillerPhrasesLabel': 'Câu đệm (mỗi câu một dòng)',
  'roleConfig.fillerPhrasesPlaceholder': 'Ừm, để mình nghĩ xíu nha\nCâu này hay nè, đợi mình một chút',
  'roleConfig.liveActive': 'Đang hoạt động',
  'roleConfig.idleInputPlaceholder': 'Nhập tin nhắn...',
  'roleConfig.autoGenerate': 'Tạo tự động',
  'roleConfig.systemPromptPlaceholder': 'Ví dụ: Bạn là trợ lý thân thiện, trả lời ngắn gọn, dễ hiểu...',
  'overview.title': 'Tổng quan',
  'overview.desc': 'Tình trạng fleet, agent runtime và hạ tầng trong 24 giờ gần nhất.',
  'overview.crumbAgent': 'Agent',
  'overview.noData': 'Chưa có dữ liệu',
  'overview.kpiRobots': 'Robots online',
  'overview.kpiConversations': 'Conversations',
  'overview.kpiToolSuccess': 'Tool success',
  'overview.kpiAvgResponse': 'Avg response',
  'overview.ofTotal': 'trên tổng {n}',
  'overview.activityTitle': 'Hoạt động hội thoại',
  'overview.activitySub': 'Số session theo giờ',
  'overview.last24h': '24 giờ',
  'overview.fleetHealth': 'Fleet health',
  'overview.healthOnline': 'Online',
  'overview.healthCert': 'Certificate hợp lệ',
  'overview.healthFirmware': 'Firmware mới nhất',
  'overview.healthSynced': 'Agent synced',
  'overview.robotsCount': '{n} robots',
  'agentCard.editInfo': 'Chỉnh sửa Thông tin',
  'agentCard.duplicate': 'Sao chép',
  'agentCard.delete': 'Xóa',
  'agentCard.editTitle': 'Chỉnh sửa Thông tin Agent',
  'agentCard.name': 'Tên Agent',
  'agentCard.namePlaceholder': 'Nhập tên Agent',
  'agentCard.description': 'Mô tả',
  'agentCard.descriptionPlaceholder': 'Mô tả vai trò, tính cách và cách trả lời của Agent',
  'agentCard.save': 'Lưu',
  'agentCard.cancel': 'Hủy bỏ',
  'agentCard.nameRequired': 'Tên Agent không được để trống',
  'agentCard.duplicateSuffix': '(bản sao)',
  'agentCard.duplicateSuccess': 'Đã sao chép Agent',
  'agentCard.duplicateFailed': 'Sao chép thất bại',
  'agentCard.duplicatePartial': 'Đã tạo Agent nhưng sao chép cấu hình thất bại',
  'agentCard.deleteTitle': 'Xóa Agent này?',
  'agentCard.deleteDesc': 'Việc xóa Agent là không thể đảo ngược. Toàn bộ cấu hình và lịch sử trò chuyện của Agent sẽ bị xóa vĩnh viễn.',
  'agentCard.confirm': 'Xác nhận',
  ...
  'roleConfig.brandingSubtitle': 'Chào mừng bạn đến với quản lý tác nhân cá nhân hóa. Cấu hình cài đặt bên dưới.',
  'roleConfig.placeholderApiKey': 'Vui lòng nhập Oriagent API KEY (app-...)',
  'roleConfig.mockPreview': 'Xem trước',
  'roleConfig.mockMessage': 'Tôi đã sẵn sàng. Nhấp vào nút cuộc gọi để bắt đầu phiên kiểm tra trực tiếp.',
  'roleConfig.testLive': 'Kiểm tra trực tiếp',
  'roleConfig.liveTestTitle': 'Khách dùng kiểm tra trực tiếp',
  'roleConfig.statusLabel': 'Trạng thái',
  'roleConfig.statAgentName': 'Tên Agent',
  'roleConfig.statLlmProvider': 'Nhà cung cấp LLM',
  'roleConfig.statDevicesOnline': 'Thiết bị trực tuyến',
  ...
  'roleConfig.voiceDetect': 'Phát hiện giọng nói',
  'roleConfig.speechRecognition': 'Nhận dạng giọng nói',
  'roleConfig.textToSpeech': 'Văn bản thành giọng nói',
  ...
  'ttsModel.voice': 'Giọng',
  'ttsModel.addNewVoice': 'Thêm giọng nói mới',
  'ttsModel.voiceNameKeyRequired': 'Mỗi giọng cần Tên giọng và API key',
  'ttsModel.voiceNameTooLong': 'Tên giọng tối đa 20 ký tự',
  'ttsModel.voiceNameDuplicate': 'Tên giọng bị trùng',
