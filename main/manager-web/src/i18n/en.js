export default {
  ...
  'header.deviceMonitor': 'Device Monitor',
  'header.serialManagement': 'Serial Management',
  'deviceMonitor.title': 'Device Monitor',
  'deviceMonitor.refresh': 'Refresh',
  'deviceMonitor.autoRefresh': 'Auto',
  'deviceMonitor.serial': 'Serial',
  'deviceMonitor.status': 'Status',
  'deviceMonitor.online': 'Online',
  'deviceMonitor.offline': 'Offline',
  'deviceMonitor.battery': 'Battery',
  'deviceMonitor.uptime': 'Uptime',
  'deviceMonitor.lastSeen': 'Last seen',
  'deviceMonitor.action': 'Action',
  'deviceMonitor.reboot': 'Reboot',
  'deviceMonitor.command': 'Command',
  'deviceMonitor.detail': 'Detail',
  'deviceMonitor.noDevices': 'No devices yet',
  'deviceMonitor.sendCommand': 'Send command',
  'deviceMonitor.action2': 'Action',
  'deviceMonitor.params': 'Params (JSON)',
  'deviceMonitor.cancel': 'Cancel',
  'deviceMonitor.send': 'Send',
  'deviceMonitor.confirmReboot': 'Reboot device {serial}?',
  'deviceMonitor.invalidJson': 'Invalid JSON params',
  'deviceMonitor.commandSent': 'Command sent',
  'serialManagement.title': 'Serial Management',
  'serialManagement.declare': 'Declare serial',
  'serialManagement.refresh': 'Refresh',
  'serialManagement.serialNumber': 'Serial Number',
  'serialManagement.statusCol': 'Status',
  'serialManagement.activated': 'Activated',
  'serialManagement.declared': 'Declared',
  'serialManagement.batch': 'Batch',
  'serialManagement.declaredAt': 'Declared at',
  'serialManagement.activatedAt': 'Activated at',
  'serialManagement.action': 'Action',
  'serialManagement.activate': 'Activate',
  'serialManagement.unbind': 'Unbind',
  'serialManagement.noSerials': 'No serials yet',
  'serialManagement.cancel': 'Cancel',
  'serialManagement.confirm': 'Confirm',
  'serialManagement.credential': 'MQTT Credential',
  'serialManagement.credentialHint': 'Password is shown once. Save it / load into device.',
  'serialManagement.copy': 'Copy',
  'serialManagement.close': 'Close',
  'serialManagement.serialRequired': 'Please enter a Serial Number',
  'serialManagement.declareSuccess': 'Serial declared',
  'serialManagement.copied': 'Copied',
  'serialManagement.confirmUnbind': 'Unbind device {serial}? (removes credential + status)',
  'serialManagement.unbindSuccess': 'Device unbound',
  'header.emojiManagement': 'Emoji/Asset Management',
  'emojiManagement.title': 'Emoji / Asset Management',
  'emojiManagement.searchPlaceholder': 'Enter name to search',
  'emojiManagement.name': 'Asset name',
  'emojiManagement.version': 'Version',
  'emojiManagement.fileSize': 'Size',
  'emojiManagement.remark': 'Remark',
  'emojiManagement.updateTime': 'Updated at',
  'emojiManagement.action': 'Action',
  'emojiManagement.addNew': 'Upload Emoji (.tar)',
  'emojiManagement.edit': 'Replace file',
  'emojiManagement.delete': 'Delete',
  'emojiManagement.copyLink': 'Copy download link',
  'emojiManagement.copied': 'Download link copied',
  'emojiManagement.copyFailed': 'Copy failed, please copy manually',
  'emojiManagement.download': 'Download',
  'emojiManagement.empty': 'No emoji file yet. Click "Upload Emoji" to add.',
  'emojiManagement.dialogTitle': 'Upload Emoji file',
  'emojiManagement.dialogEditTitle': 'Replace Emoji file (download link stays the same)',
  'emojiManagement.fileTip': 'Only .tar/.gz/.zip archives, up to 100MB',
  'emojiManagement.requiredName': 'Please enter an asset name',
  'emojiManagement.requiredFile': 'Please choose a .tar file to upload',
  'emojiManagement.invalidFileType': 'Only .tar/.gz/.zip files are allowed',
  'emojiManagement.invalidFileSize': 'File size must not exceed 100MB',
  'emojiManagement.uploadSuccess': 'Upload succeeded',
  'emojiManagement.uploadFailed': 'Upload failed',
  'emojiManagement.saveSuccess': 'Saved',
  'emojiManagement.saveFailed': 'Save failed',
  'emojiManagement.deleteSuccess': 'Deleted',
  'emojiManagement.confirmDelete': 'Are you sure you want to delete this emoji file?',
  'emojiManagement.linkLabel': 'Fixed download link',
  'emojiManagement.typeColumn': 'Type',
  'emojiManagement.resourceType': 'Resource type',
  'emojiManagement.resourceTypePlaceholder': 'e.g. emoj, logo, music, video',
  'emojiManagement.resourceTypeHint': 'Each type maps to its own fixed download link. Lowercase letters, digits and dashes only. Cannot be changed after creation.',
  'emojiManagement.requiredType': 'Please enter a resource type',
  'emojiManagement.invalidType': 'Only lowercase letters, digits and dashes (-)',
  'emojiManagement.viewApi': 'View assets API',
  'emojiManagement.copyApiUrl': 'Copy API link',
  ...
  'settings.apiExtension': 'API Extension',
  ...
  'settings.ds.add': 'Add data source',
  'settings.ds.notionDesc': 'Use Notion as a data source for Knowledge.',
  'settings.ds.addWorkspace': 'Add workspace',
  'settings.ds.websiteDesc': 'Import content from websites using web crawler.',
  'settings.ds.configure': 'Configure',
  'settings.int.connected': 'Connected',
  'settings.int.googleDesc': 'Log in with your Google account',
  'settings.int.githubDesc': 'Log in with your GitHub account',
  'settings.int.connect': 'Connect',
  'settings.api.desc': 'API extensions provide centralized API management, making configuration easy to use across applications.',
  'settings.api.empty': 'No API extensions yet',
  'settings.api.add': 'Add API Extension',
  ...
  // auth.*: shared by login + register (same design, same wording).
  // The older login.*/register.* keys belong to the previous design; left untouched.
  'auth.title': 'Device Management',
  'auth.subtitle': 'Connect ESP32 devices to your AI Agent system',
  'auth.google': 'Sign in or sign up with Google',
  'auth.or': 'or',
  ...
  'auth.captchaLabel': 'Verification code',
  'auth.captchaPlaceholder': 'Enter the verification code',
  'auth.noAccount': "Don't have an account?",
  'auth.registerNow': 'Sign up now',
  'auth.haveAccount': 'Already have an account?',
  'auth.loginBtn': 'Sign in',
  'auth.registerBtn': 'Sign up',
  'ttsModel.voiceNamePlaceholder': 'e.g. Mai voice',
  'functionDialog.jsonPlaceholder': 'Enter valid JSON',
  'cacheViewer.status': 'Status',
  'cacheViewer.cached': 'Cached',
  'cacheViewer.notCached': 'Not cached',
  'studio.navSettings': 'Settings',
  'home.searchPlaceholder': 'Search Robot Agent',
  'roleConfig.oriagentKeyPlaceholder': 'Enter a private key (app-...); leave empty to use the model\'s shared key',
  'roleConfig.fillerPreviewTitle': "Preview the filler phrase in the agent's voice",
  'roleConfig.fillerDelayLabel': 'Delay (ms)',
  'roleConfig.fillerPhrasesLabel': 'Filler phrases (one per line)',
  'roleConfig.fillerPhrasesPlaceholder': 'Hmm, let me think about that\nGood question, give me a second',
  'roleConfig.liveActive': 'Active',
  'roleConfig.idleInputPlaceholder': 'Type a message...',
  'roleConfig.autoGenerate': 'Auto generate',
  'roleConfig.systemPromptPlaceholder': 'For example: You are a friendly assistant, answer briefly and clearly...',
  'overview.title': 'Overview',
  'overview.desc': 'Fleet status, agent runtime and infrastructure over the last 24 hours.',
  ...
  'overview.ofTotal': 'of {n} total',
  'overview.activityTitle': 'Conversation activity',
  'overview.activitySub': 'Sessions per hour',
  'overview.last24h': '24 hours',
  'overview.fleetHealth': 'Fleet health',
  'overview.healthOnline': 'Online',
  'overview.healthCert': 'Valid certificate',
  'overview.healthFirmware': 'Latest firmware',
  'overview.healthSynced': 'Agent synced',
  'overview.robotsCount': '{n} robots',
  'agentCard.editInfo': 'Edit Info',
  'agentCard.duplicate': 'Duplicate',
  'agentCard.delete': 'Delete',
  'agentCard.editTitle': 'Edit Agent Info',
  'agentCard.name': 'Agent Name',
  'agentCard.namePlaceholder': 'Enter agent name',
  'agentCard.description': 'Description',
  'agentCard.descriptionPlaceholder': "Describe the agent's role, personality and how it should answer",
  'agentCard.save': 'Save',
  'agentCard.cancel': 'Cancel',
  'agentCard.nameRequired': 'Agent name cannot be empty',
  'agentCard.duplicateSuffix': '(copy)',
  'agentCard.duplicateSuccess': 'Agent duplicated',
  'agentCard.duplicateFailed': 'Duplicate failed',
  'agentCard.duplicatePartial': 'Agent created but copying its configuration failed',
  'agentCard.deleteTitle': 'Delete this Agent?',
  'agentCard.deleteDesc': 'Deleting an Agent is irreversible. All of its configuration and chat history will be permanently deleted.',
  ...
  'roleConfig.brandingSubtitle': 'Welcome to your personalized agent management. Configure settings below.',
  'roleConfig.placeholderApiKey': 'Please enter Oriagent API KEY (app-...)',
  'roleConfig.mockPreview': 'Mock Preview',
  'roleConfig.mockMessage': 'I am ready. Click the call button to start a live test session.',
  'roleConfig.testLive': 'Test Live',
  'roleConfig.liveTestTitle': 'Live Test Client',
  'roleConfig.statusLabel': 'Status',
  'roleConfig.statAgentName': 'Agent Name',
  'roleConfig.statLlmProvider': 'LLM Provider',
  'roleConfig.statDevicesOnline': 'Devices Online',
  ...
  'roleConfig.voiceDetect': 'Voice Detect',
  'roleConfig.speechRecognition': 'Speech Recognition',
  'roleConfig.textToSpeech': 'Text-to-Speech',
  ...
  'ttsModel.voice': 'Voice',
  'ttsModel.addNewVoice': 'Add New Voice',
  'ttsModel.voiceNameKeyRequired': 'Each voice needs a name and an API key',
  'ttsModel.voiceNameTooLong': 'Voice name must be at most 20 characters',
  'ttsModel.voiceNameDuplicate': 'Duplicate voice name',
